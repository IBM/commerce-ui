...
public class SearchResultsPage2 extends TestBase {
	...
	@FindBy(xpath="//ibm-table//thead/tr/th[1]/button/span")
	WebElement column_Type;
	
	
	@FindBy(xpath="//ibm-table//thead/tr/th[2]/button//ibm-dropdown//span")
	WebElement column_Store;
	
	@FindBy(xpath="//ibm-table//thead/tr/th[3]/button/span")
	WebElement column_Code;
	
	@FindBy(xpath="//ibm-table//thead/tr/th[4]/button/span")
	...
	@FindBy(xpath="//ibm-table//thead/tr/th[8]/button/span")
	WebElement column_ManufacturerPartNumber;
	
	@FindBy(xpath="//ibm-table//thead/tr/th[9]/button/span")
